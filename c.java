...
implements Runnable {
            ...
            try {
                if (this.cE == 1) {
                    ...
                    try {
                        d.O = this.b.c("anMapX");
                        d.P = this.b.c("anMapY");
                        d.Q = this.b.c("anMapCenterY");
                        d.R = this.b.c("anMapEdgeY");
                        d.S = this.b.c("anMapEdgeX");
                    }
    ...
    private void m() {
        d.a = this.a.getAppProperty("Default-Logo").equals("ON") ? 0 : 1;
        d.b = this.a.getAppProperty("More_Games").equals("ON");
        d.c = this.a.getAppProperty("Download-URL");
        d.g = this.a.getAppProperty("Default-Cheat").equals("ON");
        int n = 0;
        ...
        this.p = d.o[n][5];
        this.q = d.o[n][6];
        d.e = this.a.getAppProperty("MIDlet-Version");
    ...
    private void b(Graphics graphics) {
        ...
        graphics.fillRect(0, 58 + d.v * 15, bA, this.b.o[1] + 4);
    ...
    private void m(Graphics graphics) {
        ...
        if (n5 <= 3) {
            n3 = 186 * n5 * n5 / 9;
            n4 = n2 * n5 * n5 / 9;
            c.a(graphics, by, n6, n3, n4, 17);
            return;
        }
        if (n5 < 15) {
            c.a(graphics, by, n6, 186, n2, 17);
            graphics.setColor(0xFFFFFF);
            int n7 = 0;
        ...
        block23: {
            ...
            block24: {
                block22: {
                    ...
                    c.a(graphics, by, n3 - 40, 100, 30, 17);
                    this.b.a(graphics, this.cf[13], by, n3 - 30, 17, 1);
                    c.a(graphics, by, n3, 176, n4 + 30, 17);
                    ...
                    this.b.a(graphics, this.cf[14 + d.C], by + 20, bz - 60 + 0, 17, 1);
                    this.b.a(graphics, this.cf[20 + d.A], by + 20, bz - 60 + 30, 17, 1);
                    this.b.a(graphics, this.cf[6 + d.E], by + 20, bz - 60 + 60, 17, 1);
                    this.b.a(graphics, this.cf[10 + d.B], by + 20, bz - 60 + 90, 17, 1);
                    if (d.E != 1) break block22;
                    this.b.a(graphics, this.cf[4], by - 70, bz - 70 + 120, 20, 1);
                    this.b.a(graphics, this.cf[10 + d.F], by + 20, bz - 60 + 120, 17, 1);
                    if (!d.L) break block23;
                    this.b.a(graphics, this.cf[5], by - 70, bz - 70 + 150, 20, 1);
                    if (this.bp == 6) break block24;
                    this.b.a(graphics, this.cf[8 + d.w], by + 20, bz - 60 + 30 * (5 - n), 17, 1);
                    break block23;
                }
                if (!d.L) break block23;
    ...
    private void o(Graphics graphics) {
        ...
        c.a(graphics, by, bz + 10, n, n2 + 30, 3);
        int n4 = 0;
        int n5 = bz - 22;
        if (++this.cV > 75) {
            this.cV = -75;
    ...
    private void H() {
        ...
        c.j();
        c.k();
        System.arraycopy(g.a, 0, ChessR.o, 0, 64);
        ChessR.k = 1;
        c.a();
        bb = -4132;
        this.ez = false;
    ...
    private int L() {
        if (d.L) {
            int n = this.Y[d.w + 1][this.U][this.ae];
            this.E = n + 1;
            return n;
        }
        return this.E;
    ...
    private void Q() {
        try {
            ...
            this.db = 0;
            this.a("getitem");
            this.cZ = d.C == 0 || d.C == 1 ? this.b.e(3) : this.b.e(3 + d.C - 1);
            int n = 0;
    ...
    private boolean a(Graphics graphics, int n, int n2) {
        ...
        if (n <= 3) {
            n8 = 156 * n * n / 9;
            n9 = n5 * n * n / 9;
            c.a(graphics, by, n3, n8, n9, 3);
        } else if (n < 15) {
            c.a(graphics, by, n3, 156, n5, 3);
            graphics.setColor(0xFFFFFF);
            int n10 = 0;
    ...
    private static int a(Graphics graphics, int n, int n2, int n3, int n4, int n5, int n6) {
        ...
        if (n6 <= n4) {
            n7 = n2 * n6 * n6 / (n4 * n4);
            n8 = n3 * n6 * n6 / (n4 * n4);
            c.a(graphics, by, n, n7, n8, 3);
            return 0;
        }
        if (n6 < n5 - n4) {
            c.a(graphics, by, n, n2, n3, 3);
            return 1;
        }
        if (n6 >= n5) {
            return 2;
    ...
    private void B(Graphics graphics) {
        ...
        if (!eh) {
            eh = c.a(graphics, 0, ej++, 18, true, n, 0, n2, n3, true);
        } else if (!ei && this.dz && (ei = c.a(graphics, 0, ej++, 17, false, n, 0, n2, n3, false))) {
            if (this.U == 7) {
                this.U = 0;
                this.f();
                this.bd();
    ...
    private void ak() {
        try {
            ...
            this.dt = -4132;
            this.ak = new Image[2];
            this.a(String.valueOf(d.C) + "_imgText");
            this.ak[0] = this.b.e(d.Y);
            this.ak[1] = this.b.e(d.Z);
            this.b.b();
            this.b(24, false);
            this.a("ui_effect");
            this.ag = this.b.e(0);
    ...
    private void F(Graphics graphics) {
        ...
        switch (bu) {
            ...
            case 2: {
                ...
                if (bk != 2) {
                    if (!d.I) {
                        ...
                        if (d.L) {
                            ...
                            graphics.setColor(0xDDDDDD);
                            graphics.fillRect(bA - 70, bB - 42 + 15 * d.J, 70, 13);
                ...
                if (this.ey == 1) break;
                int n7 = Math.abs(g.a[ChessR.e + ChessR.f * 8]);
                if (n7 != 0) {
    ...
    private void H(Graphics graphics) {
        ...
        if (this.dB == -4132) {
            ...
            c.a(graphics, this.an[0], n7 + 20 + 4, n6, 2, 0, this.dE, 24);
            c.a(graphics, this.an[1], n7, n6, 2, 1, this.dE, 24);
            c.a(graphics, this.an[2], n7, n6 + 20 + 3, 2, 2, this.dE, 24);
            c.a(graphics, this.an[3], n7 + 20 + 3, n6 + 20 + 4, 2, 3, this.dE, 24);
        }
        graphics.setColor(0);
        this.bZ = n6 + 20 + 8;
        this.a(this.cg[this.bp], this.cy, this.cx, this.co);
        if (d.H != -4132) {
            int n8 = c.a(graphics, bz, 176, 40, 2, 16, d.H);
            graphics.setColor(0xFFFFFF);
            if (n8 == 1) {
    ...
    private void J(Graphics graphics) {
        ...
        c.a(graphics, by, n2, 179, n + 20, 17);
        this.b(graphics, n2);
        graphics.setColor(0x555555);
        graphics.fillRect(0, bB - 12, bA, 12);
        this.b.a(graphics, this.cf[3], bA, bB, 40, 1);
    ...
    private void a(Graphics graphics, int n, int n2, int n3, int n4) {
        if (bu == 2 || bu == 110) {
            if (!bi) {
                ...
                int[] nArray = new int[]{bg + d.S[n + n2 * 9], bg + d.S[n + n2 * 9 + 1], bg + d.S[n + (n2 + 1) * 9 + 1], bg + d.S[n + (n2 + 1) * 9]};
                int[] nArray2 = new int[]{bh + d.R[n2], bh + d.R[n2], bh + d.R[n2 + 1], bh + d.R[n2 + 1]};
                int[] nArray3 = new int[]{bg + d.S[n + n2 * 9] + 1, bg + d.S[n + n2 * 9 + 1] + 1, bg + d.S[n + (n2 + 1) * 9 + 1] + 1, bg + d.S[n + (n2 + 1) * 9] + 1};
                int[] nArray4 = new int[]{bh + d.R[n2] - 1, bh + d.R[n2] - 1, bh + d.R[n2 + 1] - 1, bh + d.R[n2 + 1] - 1};
                int n5 = 0;
                if (n3 == 0) {
                    n5 = 0xF9FF94;
    ...
    private void R(Graphics graphics) {
        ...
        graphics.drawImage(b.b("/" + d.C + ".png"), this.getWidth() / 2, this.getHeight() / 2, 17);
    }
    ...
    private boolean I(int n) {
        boolean bl = false;
        if (n == -5 || n == -6 || n == -7) {
            if (this.ef < d.U[this.U][this.bm].length - 1 && n == -7) {
                this.ee = false;
                bl = true;
            } else if (this.ef < d.U[this.U][this.bm].length - 1 || n == -6 || n == -5) {
                ++this.ef;
            }
            if (this.ef >= d.U[this.U][this.bm].length) {
                if (n == -6 || n == -5) {
                    this.ee = false;
                    bl = true;
                } else {
    ...
    private void J(int n) {
        ...
        block0 : switch (n) {
            ...
            case 54: {
                switch (this.bp) {
                    case 1: {
                        if (d.d != 6) break block0;
                        if (n == -3 || n == 52) {
                            if (--d.v < 0) {
                                d.v = 5;
                            }
                        } else if ((n == -4 || n == 54) && ++d.v > 5) {
                            d.v = 0;
                        }
                        this.bP[1] = d.v;
                        d.C = this.bP[1];
    ...
    private void S(Graphics graphics) {
        ...
        if (!d.L) {
            int n2 = 0;
            c.a(graphics, by, n - 5, 176, 159, 17);
            int n3 = 0;
            while (n3 < 3) {
                n2 = n + 45 * n3;
                if (n2 + 45 < bB) {
        ...
        if (this.av != -4132) {
            ...
            c.a(graphics, by, n - 15, 176, 27, 33);
            graphics.setColor(0xFFFFFF);
    ...
    private boolean T(Graphics graphics) {
        ...
        int n3 = 0;
        n3 = d.U[this.U][this.bm][this.ef] < 2 ? 1 : 2;
        int n4 = d.U[this.U][this.bm][this.ef];
        byte by = d.V[this.U][this.bm][this.ef];
        if (d.L && (bu == 150 || bu == 99) && n4 != 0) {
        ...
        c.a(graphics, 0, n2 - 2, bA, n + 8 + 5, 20);
        this.bZ = n2 + 5;
        System.out.println("situation ====" + d.W);
        System.out.println("nStage=====" + this.U);
        System.out.println("_nSituation=====" + this.bm);
        this.a(this.cg[d.W[this.U][this.bm] + this.ef], this.cy, this.cx, this.co);
        if (this.bm != 10) {
            graphics.setColor(0x555555);
            graphics.fillRect(0, bB - 12, bA, 12);
            if (this.ef < d.U[this.U][this.bm].length - 1) {
                this.b.a(graphics, this.cf[1], 0, bB, 36, 1);
                this.b.a(graphics, this.cf[0], bA, bB, 40, 1);
            } else {
                this.b.a(graphics, this.cf[2], 0, bB, 36, 1);
    ...
    private String bx() {
        ...
        stringBuffer.append(String.valueOf(d.A) + "*");
        stringBuffer.append(String.valueOf(d.C) + "*");
        stringBuffer.append(String.valueOf(d.E) + "*");
        stringBuffer.append(String.valueOf(d.F) + "*");
        n = this.aw.length;
        int n2 = 0;
        while (n2 < n) {
        ...
        stringBuffer.append(String.valueOf(d.z) + "*");
        stringBuffer.append(String.valueOf(d.D) + "*");
        stringBuffer.append(String.valueOf(d.w) + "*");
                    ...
                    try {
                        ...
                        if (!recordEnumeration.hasNextElement()) {
                            ...
                            while (recordEnumeration.hasNextElement()) {
                                ...
                                n = string.indexOf("*", 0);
                                d.A = Integer.parseInt(string.substring(0, n));
                                int n3 = n;
                                n = string.indexOf(42, n3 + 1);
                                d.C = Integer.parseInt(string.substring(n3 + 1, n));
                                n3 = n;
                                d.E = Integer.parseInt(string.substring(n3 + 1, n = string.indexOf(42, n3 + 1)));
                                bi = d.E == 1;
                                n3 = n;
                                n = string.indexOf(42, n3 + 1);
                                d.F = Integer.parseInt(string.substring(n3 + 1, n));
                                ...
                                n3 = n;
                                n = string.indexOf(42, n3 + 1);
                                d.B = Integer.parseInt(string.substring(n3 + 1, n));
                                n3 = n;
                                n = string.indexOf(42, n3 + 1);
                                d.z = Integer.parseInt(string.substring(n3 + 1, n));
                                n3 = n;
                                n = string.indexOf(42, n3 + 1);
                                d.D = Integer.parseInt(string.substring(n3 + 1, n));
                                System.out.println("PlayStage.LoadOption() Constants.nFirstStory = " + d.D);
                                n3 = n;
                                n = string.indexOf(42, n3 + 1);
                                d.w = Integer.parseInt(string.substring(n3 + 1, n));
                                n3 = n;
                                n = string.indexOf(42, n3 + 1);
    ...
    private void bA() {
        try {
            ...
            int n = 0;
            while (n < 64) {
                g.b[n] = dataInputStream.readByte();
                ++n;
            }
            dataInputStream.close();
            return;
    ...
    private void W(int n) {
        ...
        while (n3 < 0 + n2) {
            this.cd = this.U(n3);
            this.b.a(';');
            this.cg[n3] = this.b.a(this.cd, bA - this.b.n[d.T] * 2, (this.b.o[d.T] + this.b.o[d.T] / 2) * this.cx, this.b.n[d.T], this.b.o[d.T], this.b.o[d.T] / 2);
            if (n3 == 0) {
                this.cp = this.b.f(this.cx);
    ...
    private void X(int n) {
        ...
        while (n2 < n4 + n3) {
            ...
            this.cd = this.U(n2);
            this.b.a(';');
            this.cg[n2] = this.b.a(this.cd, bA - this.b.n[d.T] * 2, (this.b.o[d.T] + this.b.o[d.T] / 2) * this.cx, this.b.n[d.T], this.b.o[d.T], this.b.o[d.T] / 2);
            if (n2 == n4) {
                this.cp = this.b.f(this.cx);
    ...
    public final void c(int n) {
        ...
        while (n4 < n3 + n2) {
            this.cd = this.U(n4);
            this.b.a(';');
            this.cg[n4] = this.b.a(this.cd, bA - this.b.n[d.T] * 16, (this.b.o[d.T] + this.b.o[d.T] / 2) * this.cx, this.b.n[d.T], this.b.o[d.T], this.b.o[d.T] / 2);
            if (n4 == n3) {
                this.cp = this.b.f(this.cx);
                this.ci = this.cg[n3].length;
            } else if (n4 == n3 + 1) {
    ...
    private void Y(int n) {
        ...
        while (n4 < n3 + n2) {
            this.cd = this.U(n4);
            this.b.a(';');
            this.cg[n4] = this.b.a(this.cd, bA - this.b.n[d.T] * 2, (this.b.o[d.T] + this.b.o[d.T] / 2) * this.cx, this.b.n[d.T], this.b.o[d.T], this.b.o[d.T] / 2);
            if (n4 == n3) {
                this.cp = this.b.f(this.cx);
                this.ci = this.cg[n3].length;
            } else if (n4 == n3 + 1) {
    ...
    private void a(byte[][] byArray, int n, int n2, int n3) {
        if (byArray.length <= n2) {
            ...
            while (n4 < byArray.length) {
                this.b.a(this.e, byArray[n4], by, this.bZ + n4 * (this.b.o[d.T] + 2), 17, d.T);
                ++n4;
            }
            return;
        }
    ...
    private void a(Graphics graphics, i i2, int n) {
        ...
        int n4 = i2.b & 7;
        int n5 = i2.b >>> 3;
        int n6 = bi ? d.O[i2.a] : this.ae(n2) + this.bc / 2;
        int n7 = bi ? d.Q[n3] : this.ag(n3) + this.bc / 2;
        int n8 = bi ? d.O[i2.b] : this.ae(n4) + this.bc / 2;
        int n9 = bi ? d.Q[n5] : this.ag(n5) + this.bc / 2;
        graphics.setColor(n);
    ...
    private static void bE() {
        ...
        System.arraycopy(g.a, 0, byArray, 0, 64);
        byArray[64] = (byte)g.m;
